...
const templates: CVTemplate[] = [
  {
    ...
    preview: "/placeholder.svg?height=300&width=200&text=Modern+CV",
    category: "modern",
    isPremium: false,
  },
  {
    ...
    preview: "/placeholder.svg?height=300&width=200&text=Classic+CV",
    category: "classic",
    isPremium: false,
  },
  {
    ...
    preview: "/placeholder.svg?height=300&width=200&text=Creative+CV",
    category: "creative",
    isPremium: true,
  },
  {
    ...
    preview: "/placeholder.svg?height=300&width=200&text=Minimal+CV",
    category: "minimal",
    isPremium: false,
  },
  {
    ...
    preview: "/placeholder.svg?height=300&width=200&text=Executive+CV",
    category: "modern",
    isPremium: true,
  },
  {
    ...
    description: "Portfolio-style layout for showcasing work",
    preview: "/placeholder.svg?height=300&width=200&text=Portfolio+CV",
    category: "creative",
    isPremium: true,
  },
]
