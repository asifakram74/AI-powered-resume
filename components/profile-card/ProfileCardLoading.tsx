"use client"
import { Sparkles, Zap, IdCard } from "lucide-react"
...
export function ProfileCardLoading({ 
  loadingText = "Setting up Profile Card", 
  subText = "We're organizing and formatting your data so you can edit smoothly." 
}: ProfileCardLoadingProps) {
  return (
    <div className="min-h-screen resumaic-gradient-subtle flex items-center justify-center relative overflow-hidden z-50 fixed inset-0 bg-white dark:bg-gray-950">
      ...
      <div className="text-center max-w-md mx-auto px-6 relative z-10">
        ...
        <div className="relative mb-8 animate-fade-in">
          <div className="w-24 h-24 mx-auto relative">
            ...
            <div className="absolute inset-1 bg-white dark:bg-gray-950 rounded-full shadow-2xl flex items-center justify-center animate-pulse-gentle">
              <IdCard className="w-10 h-10 text-emerald-600 animate-bounce-gentle" />
            </div>
            {/* Inner glow */}
        ...
        <div className="space-y-6 animate-fade-in-up animation-delay-300">
          <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100 flex items-center justify-center gap-3 animate-pulse-gentle">
            ...
            <span className="resumaic-text-gradient bg-clip-text text-transparent">{loadingText}</span>
