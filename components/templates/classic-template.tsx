  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-12 min-h-screen">
                  ...
                  <div className="text-gray-600 text-sm">
                    {project.liveDemoLink && (
                      <span>
                        ...
                        <a href={project.liveDemoLink} className="text-blue-600 hover:underline">
                          {project.liveDemoLink}
                        </a>
                      </span>
                    )}
                    {project.liveDemoLink && project.githubLink && <span> | </span>}
                    {project.githubLink && (
                      <span>
                ...
                <div>
                  ...
                  {cert.verificationLink && (
                    <span>
                      {" "}
                      (
                      <a href={cert.verificationLink} className="text-blue-600 hover:underline text-sm">
                        Verify
                      </a>
                      )
                    </span>
      ...
      {data.additional.interests.length > 0 && (
        <div>
          <h2 className="text-xl font-bold text-gray-900 mb-4 border-b border-gray-300 pb-1">INTERESTS & HOBBIES</h2>
