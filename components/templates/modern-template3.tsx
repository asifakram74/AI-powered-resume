        ...
        <div className="max-w-5xl mx-auto px-8 pb-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6 print:break-inside-avoid">
              {/* Skills Card */}
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 print:break-inside-avoid">
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* Experience Card */}
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 print:break-inside-avoid">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 print:break-inside-avoid">
                  ...
                  <div className="grid gap-6">
                    {data.projects.map((project) => (
                      <div
                        key={project.id}
                        className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-xl p-6 border border-slate-200 print:break-inside-avoid"
                      >
