...
const PDFUploader = ({ onDataExtracted, onProcessingStart }: PDFUploaderProps) => {
  ...
  return (
    <div className="space-y-2">
            ...
            <>
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-gray-900">
                {/* <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-xs font-bold text-emerald-600">{Math.round(safeProgress)}%</span>
                </div> */}
              </div>
      ...
      {/* Processing Status Card - Only shows when processing */}
      {/* {isProcessing && (
        <Card className="p-4 border-l-4 border-l-emerald-500 bg-emerald-50">
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm font-medium text-gray-800">Processing Resume</span>
            ...
            <div className="space-y-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="font-medium text-gray-800">{processingStep}</span>
              </div>
              <div className="flex justify-between text-xs">
                <span className="text-gray-600">Status:</span>
                <span className="text-emerald-600 font-medium">{getFriendlyMessage(safeProgress)}</span>
              </div>
            </div>
          </div>
        </Card>
