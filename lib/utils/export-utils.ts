...
export const exportToDOCX = async (htmlContent: string, filename: string = 'cv.docx') => {
  try {
    ...
    // console.log('Making request to:', 'https://stagingbackendserver.resumaic.com/api/export-docx');
    ...
    // const response = await fetch('https://stagingbackendserver.resumaic.com/api/export-docx', {
      method: 'POST',
      headers: {
